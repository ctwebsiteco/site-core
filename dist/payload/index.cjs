...
var dbD1Sqlite = require('@payloadcms/db-d1-sqlite');
var richtextLexical = require('@payloadcms/richtext-lexical');
var pluginFormBuilder = require('@payloadcms/plugin-form-builder');
var emailResend = require('@payloadcms/email-resend');
var ssr = require('@supabase/ssr');
var jose = require('jose');
var cloudflare = require('@opennextjs/cloudflare');
...
async function createPayloadConfig(opts) {
  ...
  const config = {
    ...
    editor: richtextLexical.lexicalEditor({}),
    ...
    email,
    db: dbD1Sqlite.sqliteD1Adapter({
      binding,
      migrationDir: path__default.default.resolve(rootDir, "..", "migrations")
    }),
    typescript: {
      outputFile: typesOutputFile ?? path__default.default.resolve(rootDir, "payload-types.ts")
    },
    plugins: [
      pluginFormBuilder.formBuilderPlugin({
        fields: formFields,
        formOverrides: {
          admin: {
            group: "Forms",
